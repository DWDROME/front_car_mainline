...
int main()
{
    ...
    expect_float("default vehicle raw ref x", defaults.vehicle_raw_ref_x, 80.0F, &failed);
    ...
    expect_float("bad vehicle raw ref x keeps default", after_bad.vehicle_raw_ref_x, 80.0F, &failed);
    ...
    expect_float("valid vehicle raw ref x applied", after_valid.vehicle_raw_ref_x, 65.0F, &failed);
    ...
    write_config("# inline comments should not become numeric tails\n"
                 ...
                 "vehicle_raw_ref_x: 66.0 # raw camera x\n"
    ...
    expect_float("comment vehicle raw ref x applied", after_comments.vehicle_raw_ref_x, 66.0F, &failed);
    ...
    expect_float("unknown key keeps vehicle raw ref x", after_unknown.vehicle_raw_ref_x, 66.0F, &failed);
    ...
    expect_float("bad vehicle raw ref x keeps previous", after_trailing.vehicle_raw_ref_x, 66.0F, &failed);
