...
//    }
    ...
    resample_points(far_rpts0b, far_rpts0b_num, far_rpts0s, &far_rpts0s_num, point_sample_dist);
    far_rpts1s_num = sizeof(far_rpts1s) / sizeof(far_rpts1s[0]);
    resample_points(far_rpts1b, far_rpts1b_num, far_rpts1s, &far_rpts1s_num, point_sample_dist);
