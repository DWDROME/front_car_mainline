...
- duration_seconds: 6
- local_log: logs/live-circle/20260621-drive172-front_car_circle_drive172.log
- remote_log: /tmp/front_car_circle_drive172.log
- started_at: 2026-06-25T21:05:12+08:00

## Commands

```bash
.trellis/tasks/06-21-circle-exit-line-evidence-baseline/live_circle_test.sh run drive172 6
```

3280 /tmp/front_car_circle_drive172.log
ATGCircleEntryInnerHit: side=L near=1@5 seed=32,71 hit=1@15,37 ray=-1,-2 sharp=0 raw=32.6,71.6 th=69
ATGCircleEntryProbe: side=L A=1@5(raw=30,76) B=0 ret=0 reason=no_extreme detail=jump_bad hits=36 rise=36 range=61..26 scan_x=50 best=115,61 dx=85 inner_dx=85 dy=15 up_dy=15 dist2=7450 jump=1 sharp_far=0
...
ATGCircleEntryProbe: side=L A=1@4(raw=31,79) B=0 ret=0 reason=no_extreme detail=jump_bad hits=36 rise=36 range=64..29 scan_x=51 best=116,64 dx=85 inner_dx=85 dy=15 up_dy=15 dist2=7450 jump=1 sharp_far=0
frame=911 line=1 track=1 cross=0 circle=0(CIRCLE_NONE) round=0 yroad=0 ramp=0 road=7 speed=0 near=12/124 raw=60/105 sel=124/126 src=11 far=0/0 far_raw=0/0 l=1@4/0@-1 far_l=0@-1/0@-1 straight=0/1 far_straight=0/0 circle_cnt=0/0/0/0 lost=0/0 ref=0 A=0@-1,-1#0 B=0@-1,-1#-1 C=0@-1,-1#0 conf=94.4/7.1/0.0/0.0 dist=0 begin=0/0 m0=(84,119) ml=(85,78) md=41/1/136 cxcy=84.0,119.6 guide=-1.24 atg=2.0/1.0/2.0 pure=-0.61/-0.53 yaw=42 cmd=129 actual=-1 signed=0 rps=4795/5148:0/0 duty=24/28 pwm=PWM2:24/PWM1:28 motor=2:24/1:28
...
ATGCircleEntryInnerHit: side=L near=1@5 seed=32,71 hit=1@15,37 ray=-1,-2 sharp=0 raw=32.6,71.6 th=70
ATGCircleEntryProbe: side=L A=1@5(raw=30,76) B=0 ret=0 reason=no_extreme detail=jump_bad hits=36 rise=36 range=61..26 scan_x=50 best=115,61 dx=85 inner_dx=85 dy=15 up_dy=15 dist2=7450 jump=1 sharp_far=0
ATGCircleEntryInnerHit: side=L near=1@5 seed=32,71 hit=1@17,41 ray=-1,-2 sharp=0 raw=32.6,71.6 th=152
ATGCircleEntryProbe: side=L A=1@5(raw=30,76) B=0 ret=0 reason=no_extreme detail=jump_bad hits=36 rise=36 range=61..26 scan_x=50 best=115,61 dx=85 inner_dx=85 dy=15 up_dy=15 dist2=7450 jump=1 sharp_far=0
ATGCircleEntryInnerHit: side=L near=1@4 seed=33,74 hit=1@15,38 ray=-1,-2 sharp=0 raw=33.2,74.9 th=89
ATGCircleEntryProbe: side=L A=1@4(raw=31,79) B=0 ret=0 reason=no_extreme detail=jump_bad hits=36 rise=36 range=64..29 scan_x=51 best=116,64 dx=85 inner_dx=85 dy=15 up_dy=15 dist2=7450 jump=1 sharp_far=0
...
- stopped_at: 2026-06-25T21:05:24+08:00

## Review

```bash
.trellis/tasks/06-21-circle-exit-line-evidence-baseline/live_circle_test.sh review drive172
```
